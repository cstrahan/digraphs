var Digraphs = new function() {
  ...
  "O>2":    "\u1ed4", "o>2":    "\u1ed5", "O>?":    "\u1ed6", "o>?":    "\u1ed7",
  "O>-.":   "\u1ed8", "o>-.":   "\u1ed9", "O9'":    "\u1eda", "o9'":    "\u1edb",
  "O9!":    "\u1edc", "o9!":    "\u1edd", "O92":    "\u1ede", "o92":    "\u1edf",
  "O9?":    "\u1ee0", "o9?":    "\u1ee1", "O9-.":   "\u1ee2", "o9-.":   "\u1ee3",
  "U-.":    "\u1ee4", "u-.":    "\u1ee5", "U2":     "\u1ee6", "u2":     "\u1ee7",
  "U9'":    "\u1ee8", "u9'":    "\u1ee9", "U9!":    "\u1eea", "u9!":    "\u1eeb",
  "U92":    "\u1eec", "u92":    "\u1eed", "U9?":    "\u1eee", "u9?":    "\u1eef",
  "U9-.":   "\u1ef0", "u9-.":   "\u1ef1", "Y!":     "\u1ef2", "y!":     "\u1ef3",
  "Y-.":    "\u1ef4", "y-.":    "\u1ef5", "Y2":     "\u1ef6", "y2":     "\u1ef7",
  "Y?":     "\u1ef8", "y?":     "\u1ef9", ";'":     "\u1f00", ",'":     "\u1f01",
  ";!":     "\u1f02", ",!":     "\u1f03", "?;":     "\u1f04", "?,":     "\u1f05",
  ...
  "4R":     "\u2163", "5R":     "\u2164", "6R":     "\u2165", "7R":     "\u2166",
  "8R":     "\u2167", "9R":     "\u2168", "aR":     "\u2169", "bR":     "\u216a",
  "cR":     "\u216b", "50R":    "\u216c", "100R":   "\u216d", "500R":   "\u216e",
  "1000R":  "\u216f", "1r":     "\u2170", "2r":     "\u2171", "3r":     "\u2172",
  "4r":     "\u2173", "5r":     "\u2174", "6r":     "\u2175", "7r":     "\u2176",
  "8r":     "\u2177", "9r":     "\u2178", "ar":     "\u2179", "br":     "\u217a",
  "cr":     "\u217b", "50r":    "\u217c", "100r":   "\u217d", "500r":   "\u217e",
  "1000r":  "\u217f", "1000RCD": "\u2180", "5000R":  "\u2181", "10000R": "\u2182",
  "<-":     "\u2190", "-!":     "\u2191", "->":     "\u2192", "-v":     "\u2193",
  "<>":     "\u2194", "UD":     "\u2195", "<!!":    "\u2196", "//>":    "\u2197",
  "!!>":    "\u2198", "<//":    "\u2199", "<=":     "\u21d0", "=>":     "\u21d2",
  "==":     "\u21d4", "FA":     "\u2200", "dP":     "\u2202", "TE":     "\u2203",
  ...
  chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
      if (request == "enter-digraph") {
        that.di = "";
      }
    });

  // Unlike Firefox, we can't just simulate a keypress when it comes to text
  // fields, so we have to manually modify the value.
  ...
  function keyPressHandler(event) {
    if ("digraph_pass" in event) {
      ...
      if (that.di.length > 1) {
        ...
        if (id == null) {
          ...
          if (! maybe) {
            ...
            var chr = that.di.substring(that.di.length - 1);
            fakeKey(event, chr);
            insertAtCursor(event.target, chr);
            that.di = null;
          }
        } else {
          fakeKey(event, id);
          insertAtCursor(event.target, id);
          that.di = null;
        }
      }
      ...
      return false;
    } else if (event.ctrlKey && event.which == "k") {
      that.di = "";
      event.preventDefault();
      event.stopPropagation();
      return false;
